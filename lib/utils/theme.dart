...
const UICThemeData _default = UICThemeData(
  /// Colors
  bluish: UICThemeColors.bluish,
  darkBluish: UICThemeColors.darkBluish,
  reddish: UICThemeColors.reddish,
  warmRed: UICThemeColors.warmRed,
  limeGreenish: UICThemeColors.limeGreenish,
  white: UICThemeColors.white,
  black: UICThemeColors.black,
  gray: UICThemeColors.gray,
  deepGray: UICThemeColors.deepGray,
  darkGray: UICThemeColors.lightGray,
  lightGray: UICThemeColors.lightGray,
  buttonRed: UICThemeColors.buttonRed,
  ...
  buttonTextSuccess: TextStyle(
      ...
      fontFamily: 'Gilroy',
      fontWeight: FontWeight.w300,
      color: UICThemeColors.limeGreenish),
...
/// See Usage below.
///
/// The values for the Theme are provided by [UICThemeData].
/// (The properties of [UICThemeData] are the design tokens for the UI.)
///
...
class UICTheme extends InheritedWidget {
  UICTheme({this.data = _default, @required this.child}) : super(child: child);

  /// The design tokens used by UI Components to apply styling.
  final UICThemeData data;
  final Widget child;

  /// Use to get a reference to the nearest available [UICThemeData] anywhere
  /// in the widget tree below the child widget.
  ///
  /// ```
  /// var themeData = JFTheme.of(context);
  /// ```
  static UICThemeData of(BuildContext context) {
    ...
    final UICTheme currentTheme =
        context.dependOnInheritedWidgetOfExactType<UICTheme>();
  ...
  bool updateShouldNotify(InheritedWidget oldWidget) {
    return data == (oldWidget as UICTheme).data;
  }
}
